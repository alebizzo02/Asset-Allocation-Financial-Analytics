...
The objective is not simply to compare companies, but to construct portfolios tailored to different risk profiles using an integrated factor approach grounded in financial logic.
...
How can fundamental and risk-based metrics be combined to:
	...
	•	Distinguish growth leaders from value names
	•	Evaluate business quality via ROIC and margins
...
The analytical workflow follows a structured bottom-up process:
	...
	3.	Integrated composite evaluation
	4.	Portfolio construction based on expected return and correlation
	5.	Risk-return efficiency assessment
...
Conservative
Focus on stability, lower beta, and margin consistency

Moderate
Balanced exposure across growth and value

Growth
High allocation to high-CAGR, high-ROIC equities
